...
| Structure | `mixed-concerns`, `inline-tests`, `let-underscore-result`, `high-param-count`, `long-function-body`, `module-root-definitions`, `large-source-file`, `high-method-count`, `item-visibility-policy`, `ungated-test-api`, `conflicting-module-root`, `flat-module-family`, `feature-boundary` |

...
impl ViolationType {
    ...
    pub fn check_name(&self) -> &'static str {
        match self {
            Self::MaxDepth => "nesting",
            Self::NestedIf | Self::IfInMatch | Self::NestedMatch | Self::MatchInIf => "nesting",
